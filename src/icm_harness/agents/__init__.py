"""Public interface (barrel) for the ``agents`` module.

Other modules must import these symbols from ``icm_harness.agents`` — never from
...
_PUBLIC: dict[str, str] = {
    "StageAgent": "contracts",
    "StageInvocation": "contracts",
    "StageAgentError": "errors",
...
def __getattr__(name: str) -> Any:
    ...
    return getattr(importlib.import_module(f"icm_harness.agents.{module}"), name)
