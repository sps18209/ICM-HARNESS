"""Public interface (barrel) for the ``routing`` module.

Other modules must import these symbols from ``icm_harness.routing`` — never from
...
_PUBLIC: dict[str, str] = {
    "HeuristicCorrelation": "correlation",
    "BayesianPerformanceStore": "learning",
    "ModeRouter": "mode_router",
...
def __getattr__(name: str) -> Any:
    ...
    return getattr(importlib.import_module(f"icm_harness.routing.{module}"), name)
