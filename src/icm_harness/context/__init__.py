"""Public interface (barrel) for the ``context`` module.

Other modules must import these symbols from ``icm_harness.context`` — never from
...
_PUBLIC: dict[str, str] = {
    ...
    "estimate_tokens": "budgets",
    "ContextEngine": "engine",
    "FilesystemWikiProvider": "retrieval",
    "ContextTrigger": "triggers",
}
...
def __getattr__(name: str) -> Any:
    ...
    return getattr(importlib.import_module(f"icm_harness.context.{module}"), name)
