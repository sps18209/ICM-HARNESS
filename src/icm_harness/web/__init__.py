"""Public interface (barrel) for the ``web`` module.

Other modules must import these symbols from ``icm_harness.web`` — never from
...
def __getattr__(name: str) -> Any:
    ...
    return getattr(importlib.import_module(f"icm_harness.web.{module}"), name)
