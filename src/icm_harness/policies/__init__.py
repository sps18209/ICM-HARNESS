"""Public interface (barrel) for the ``policies`` module.

Other modules must import these symbols from ``icm_harness.policies`` — never from
...
def __getattr__(name: str) -> Any:
    ...
    return getattr(importlib.import_module(f"icm_harness.policies.{module}"), name)
